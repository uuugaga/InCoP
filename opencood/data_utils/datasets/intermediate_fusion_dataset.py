...
def getIntermediateFusionDataset(cls):
    ...
    class IntermediateFusionDataset(cls):
        ...
        def __getitem__(self, idx):
            ...
            if object_class_id_stack and hasattr(self, "set_last_class_ids_from_values"):
                object_class_id_stack = np.asarray(object_class_id_stack, dtype=np.int64)
                self.set_last_class_ids_from_values(
                    object_class_id_stack[unique_indices]
                )
